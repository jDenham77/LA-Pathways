...
class UserWizardForm extends React.Component {
  ...
  mapAnswer = (answer, typeId, length) => (
    <Answer
  ...
  render() {
    return (
      <div className="container-fluid header-margin">
        <div className="row m-3 justify-content-center header">
          <div className="offset-sm-3 col-9">
        ...
        <div className="row">
          <strong className="m-auto validation">
        ...
        <div className="row mt-3">
          {this.state.currentPage > 0 ? (
            <div className="col">
              <button
                className="btn btn-pill btn-secondary float-right wizardFormPreviousBtn"
                type="button"
                onClick={this._prev}
              >
                Previous
          ...
          {this.state.currentPage === 7 ? (
            <div className="col">
              <button
                ...
                className="btn btn-pill btn-success sweet-3 float-left"
            ...
            <div
              className={this.state.currentPage === 0 ? "offset-md-6" : "col"}
            >
              <button
                className={
                  this.state.currentPage === 0
                    ? "btn-pill btn float-right wizardFormBtn"
                    : "btn btn-pill wizardFormBtn"
                }
                type="button"
                onClick={this._next}
                disabled={!this.state.isValid}
